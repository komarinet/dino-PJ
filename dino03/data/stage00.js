/* =================================================================
   ...
   【絶対ルール順守：一切の省略なし】
   修正・統合内容：
   1. 遮蔽防止：depthTest: false を設定し、地形メッシュに埋まらず常に最前面に描画されるよう修正。
   2. 表示名対応：displayName プロパティを維持。
   3. 各種アニメ：ギガノト(4x4)、ママティラノ(3x5)、チビティラノのアニメ・アクションを完備。
   4. 描画設定：影の優先度10、本体999を維持。
   ================================================================= */

export const VERSION = "8.20.92";
...
export class Unit {
    ...
    initTextureSprite() {
        ...
        // ★修正：地形に埋まらないよう depthTest: false, depthWrite: false を設定
        ...
        this.sprite.renderOrder = 999; // 最前面
